...
func (j *jsiiProxy_JavaServiceInstance) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_JavaServiceInstance)SetCount(val interface{}) {
...
// Experimental.
func JavaServiceInstance_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateJavaServiceInstance_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func JavaServiceInstance_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateJavaServiceInstance_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool

...
func (j *jsiiProxy_ApplicationContainer) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ApplicationContainer)SetCount(val interface{}) {
...
func ApplicationContainer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateApplicationContainer_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApplicationContainer) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApplicationContainer) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApplicationContainer) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApplicationContainer) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApplicationContainer) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_ApplicationContainer) MoveToId(id *string) {
...
func (a *jsiiProxy_ApplicationContainer) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_ApplicationContainer) ToHclTerraform() interface{} {
	var returns interface{}

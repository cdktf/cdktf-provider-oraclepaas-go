...
import (
	...
	"github.com/cdktf/cdktf-provider-oraclepaas-go/oraclepaas/v8/dataoraclepaasdatabaseserviceinstance/internal"
...
func (j *jsiiProxy_DataOraclepaasDatabaseServiceInstance) Count() interface{} {
...
func (j *jsiiProxy_DataOraclepaasDatabaseServiceInstance)SetCount(val interface{}) {
...
func DataOraclepaasDatabaseServiceInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataOraclepaasDatabaseServiceInstance_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataOraclepaasDatabaseServiceInstance) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataOraclepaasDatabaseServiceInstance) ToHclTerraform() interface{} {
	var returns interface{}

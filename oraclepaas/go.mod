// Deprecated: HashiCorp is no longer publishing new versions of the prebuilt provider for oraclepaas.
...
// You can continue to use the oraclepaas provider in your CDK for Terraform projects with newer versions of CDKTF,
// but you will need to generate the bindings locally. See https://cdk.tf/imports for details.
module github.com/cdktf/cdktf-provider-oraclepaas-go/oraclepaas/v8

...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MysqlAccessRule)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-oraclepaas.mysqlAccessRule.MysqlAccessRuleConfig",
		reflect.TypeOf((*MysqlAccessRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-oraclepaas.mysqlAccessRule.MysqlAccessRuleTimeouts",
		reflect.TypeOf((*MysqlAccessRuleTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-oraclepaas.mysqlAccessRule.MysqlAccessRuleTimeoutsOutputReference",
		reflect.TypeOf((*MysqlAccessRuleTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{

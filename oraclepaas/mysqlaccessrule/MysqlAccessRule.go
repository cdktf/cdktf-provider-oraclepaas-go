...
func (j *jsiiProxy_MysqlAccessRule) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_MysqlAccessRule)SetCount(val interface{}) {
...
func MysqlAccessRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMysqlAccessRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MysqlAccessRule) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MysqlAccessRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MysqlAccessRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MysqlAccessRule) MoveFromId(id *string) {
...
func (m *jsiiProxy_MysqlAccessRule) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MysqlAccessRule) MoveToId(id *string) {
...
func (m *jsiiProxy_MysqlAccessRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MysqlAccessRule) ToHclTerraform() interface{} {
	var returns interface{}

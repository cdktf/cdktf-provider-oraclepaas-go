...
func (j *jsiiProxy_DatabaseServiceInstance) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DatabaseServiceInstance)SetCount(val interface{}) {
...
func DatabaseServiceInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDatabaseServiceInstance_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DatabaseServiceInstance) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DatabaseServiceInstance) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DatabaseServiceInstance) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DatabaseServiceInstance) MoveFromId(id *string) {
...
func (d *jsiiProxy_DatabaseServiceInstance) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DatabaseServiceInstance) MoveToId(id *string) {
...
func (d *jsiiProxy_DatabaseServiceInstance) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DatabaseServiceInstance) ToHclTerraform() interface{} {
	var returns interface{}
